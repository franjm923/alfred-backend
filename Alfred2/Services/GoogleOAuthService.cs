...
public class GoogleOAuthService
{
    ...
    public string GetConsentUrl()
    {
        ...
        var url = $"https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id={Uri.EscapeDataString(clientId)}&redirect_uri={Uri.EscapeDataString(redirectUri)}&scope={Uri.EscapeDataString(scopes)}&access_type=offline&prompt=consent&include_granted_scopes=true";
        return url;
    }
